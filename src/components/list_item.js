        ...
        return(
            <TouchableOpacity onPress={this._handlePress} style={{flexDirection:'row'}} activeOpacity={0.5}>
                <Thumbnail style={{ backgroundColor: '#eee', alignSelf: 'center' }} square large 
                 source={{ cache:'force-cache', uri: this.data.urlToImage != null ? 
                 "http://image-api.suckup.de/image-api.php?file="+this.data.urlToImage+
                 "&quality=25" : 'data:image/png;base64,' }} />
                <Body>
